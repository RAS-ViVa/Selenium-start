...
public class AddFilm extends TestBase {
  ...
  @Test
  public void testAddFilm() throws Exception {    driver.findElement(By.cssSelector("img[alt=\"Add movie\"]")).click();
    driver.findElement(By.id("imdbsearch")).clear();
    driver.findElement(By.id("imdbsearch")).sendKeys("My");
    ...
    driver.findElement(By.name("aka")).sendKeys("описание фильма");
